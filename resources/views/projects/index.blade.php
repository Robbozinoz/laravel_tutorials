...
<body>
    <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="https://laravel.com">
            ...
            <a class="navbar-item" href="/home">App Home</a>
            <a class="navbar-item" href="/projects">Project Home</a>
    ...
    <div class="column container"  style="margin: 2rem;">
        ...
        <ul style="margin: 2rem;">
            ...
            <li  style="margin-bottom: 1rem;"><a class="button is-link" href="/projects/{{ $project->id }} ">{{ $project->id }} - {{ $project->title }} </a></li>
            @endforeach
        </ul>
    </div>
</div>
